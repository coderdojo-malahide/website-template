...
function cff_welcome_screen_new_content() { ?>
    <div class="wrap about-wrap cff-welcome">
        ...
        <p class="about-description"><?php _e("Let's take a look at some of the new features and improvements in version 3.0."); ?></p>
...
function cff_welcome_header(){ ?>
    ...
    <div id="cff-header">
        ...
        <p class="about-text">
            <?php _e("Thanks for installing <b>Version 3.0</b> of the Custom Facebook Feed Pro plugin! This update is packed full of new features and improvements. Take a look below to see what's new."); ?>
        </p>
    </div>
<?php }
                ...
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <a class="cff-tooltip-link" href="JavaScript:void(0);" style="position: relative; top: -10px;"><?php _e("Why isn't the line showing?"); ?></a>
